...
WAL files live in <data_dir>/wal and are named by the first offset they
contain:  %020d.wal.  Rotation happens at segment-seal boundaries so each
sealed segment maps to exactly one WAL file (kept for a retention window to
allow rebuilding a corrupted segment).
"""
